...
st.set_page_config(page_title="HealthEats Analyzer", page_icon=":apple:")


st.markdown(
    "<h1 style='color: #0D9276;'>HealthEats Analyzer</h1>",
    unsafe_allow_html=True
)

# Adding description with custom font color
st.markdown(
    "<p style='color: #164B60;'>Welcome to Health Eats Analyzer! This app analyzes the nutritional value of your food.</p>",
    unsafe_allow_html=True
)
...
You are an expert in nutritionist where you need to see the food items from the image
        ...
        Finally You can mention whether the food is healthy or not. And also the percentage proportion of different
        nutritents in below format and every value should be next line
            a). total fat -- precentage 
            b). saturated fat
            c). trans fat
            d). cholesterol
            e). sodium
